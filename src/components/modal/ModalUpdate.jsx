...
const ModalUpdate = ({
  ...
  useEffect(() => {
    if (inputKeyRef.current) {
      inputKeyRef.current.value = keyValue;
    }
  }, [keyValue]);
  ...
  useEffect(() => {
    if (defaultValueColor) {
      setColor(`#${defaultValueColor}`);
    }
  }, [defaultValueColor]);
    ...
    <MyModal isOpen={showModal} width={"80%"} closeModal={closeModal}>
      <div className="w-full flex flex-col gap-2 pb-3 lg:h-[532px] h-auto">
        ...
        <div className="w-full md:mt-5 mt-2 h-full">
          <form
            action=""
            className="md:p-5 md:border-2 border-gray-300 h-full flex flex-col justify-between"
            onSubmit={onSubmit}
          ...
          >
                ...
                <div className="flex flex-col md:flex-row mt-6 md:gap-3 gap-5">
                  <div className="flex flex-col gap-1 md:w-1/2">
                    ...
                    <input
                      ...
                      id="color"
                      defaultValue={
                        defaultValueColor ? `#${defaultValueColor}` : "#ffffff"
                      }
            ...
            <div className="flex gap-2 mt-5 md:mt-3">
              <Button title={"Update"} typeBtn={"submit"} disabled={loading} />
